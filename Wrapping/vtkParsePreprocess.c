...
static int preproc_find_macro(
  PreprocessInfo *info, const char *name, unsigned long *idx)
{
  unsigned long i, n;
  size_t m;
  const char *cp = name;
    ...
    if (strncmp("defined", tokens->text, tokens->len) == 0)
      ...
      *is_unsigned = 0;
      ...
      if (*cp != '\0')
        ...
        macro->IsExcluded = 0;
        vtkParsePreprocess_FreeString(info, expansion);
        return result;
        }
      vtkParsePreprocess_FreeString(info, expansion);
      }
  ...
  PreprocessInfo *info, int platform)
{
  ...
  /* windows macros */
  if (platform == VTK_PARSE_WIN32)
    {
    preproc_add_macro_definition(info, "WIN32", "1");
    preproc_add_macro_definition(info, "_WIN32", "1");
    preproc_add_macro_definition(info, "_MSC_VER", "1400");
    }
  else if (platform == VTK_PARSE_NATIVE)
    {
#ifdef WIN32
  ...
  /* cygwin macros */
  if (platform == VTK_PARSE_CYGWIN)
    {
    preproc_add_macro_definition(info, "WIN32", "1");
    preproc_add_macro_definition(info, "_WIN32", "1");
    preproc_add_macro_definition(info, "__CYGWIN__", "1");
    }
  else if (platform == VTK_PARSE_NATIVE)
    {
#ifdef __CYGWIN__
  ...
  /* mingw macros */
  if (platform == VTK_PARSE_MINGW)
    {
    preproc_add_macro_definition(info, "WIN32", "1");
    preproc_add_macro_definition(info, "_WIN32", "1");
    preproc_add_macro_definition(info, "MINGW", "1");
    preproc_add_macro_definition(info, "__MINGW32__", "1");
    }
  else if (platform == VTK_PARSE_NATIVE)
    {
#ifdef MINGW
  ...
  /* borland macros */
  if (platform == VTK_PARSE_BORLAND)
    {
    preproc_add_macro_definition(info, "WIN32", "1");
    preproc_add_macro_definition(info, "_WIN32", "1");
    preproc_add_macro_definition(info, "BORLAND", "1");
    preproc_add_macro_definition(info, "__BORLAND__", "1");
    }
  else if (platform == VTK_PARSE_NATIVE)
    {
#ifdef __BORLAND__
  ...
  /* linux macros */
  if (platform == VTK_PARSE_LINUX)
    {
    preproc_add_macro_definition(info, "__linux__", "1");
    preproc_add_macro_definition(info, "__LINUX__", "1");
    preproc_add_macro_definition(info, "__GNUC__", "3");
    }
  else if (platform == VTK_PARSE_NATIVE)
    {
#ifdef __linux__
  ...
  /* APPLE macros */
  if (platform == VTK_PARSE_APPLE)
    {
    preproc_add_macro_definition(info, "__APPLE__", "1");
    preproc_add_macro_definition(info, "__MACH__", "1");
    preproc_add_macro_definition(info, "__DARWIN__", "1");
    preproc_add_macro_definition(info, "__GNUC__", "3");
    }
  else if (platform == VTK_PARSE_NATIVE)
    {
    ...
    if (l > 0)
      ...
      if (stringify)
        ...
        if (text)
          ...
          strncpy(&rp[i], text, l);
          vtkParsePreprocess_FreeString(info, text);
          }
    ...
    if (tokens.tok == TOK_ID)
      ...
      if (macro)
        ...
        if (expand)
          ...
          vtkParsePreprocess_FreeString(info, processed);
          }
        }
      }
...
/**
 * Free a string returned by ExpandMacro or ProcessString
 */
